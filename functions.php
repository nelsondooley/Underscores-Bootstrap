...
function underscores_bootstrap_setup() {
	...
	register_nav_menus( array(
		'primary' => esc_html__( 'Primary', 'underscores-bootstrap' ),
	) );
	...
	add_theme_support( 'custom-background', apply_filters( 'underscores_bootstrap_custom_background_args', array(
...
function underscores_bootstrap_scripts() {
	wp_enqueue_style( 'underscores-bootstrap-style', get_stylesheet_uri() );

	wp_enqueue_script( 'underscores-bootstrap-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );
